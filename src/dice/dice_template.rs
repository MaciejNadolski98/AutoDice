...
use crate::{constants::{dice_texture::{FONT_SIZE, INNER_SIZE, OFFSET, PIPS_POSITION, SCALING_FACTOR, TARGET_SIZE}, DICE_FACES_LAYER}, loading_screen::AssetStore};
...
fn spawn_dice_faces(
  ...
  let dice = world.get::<DiceTemplate>(context.entity).unwrap().clone();
  world
    .commands()
